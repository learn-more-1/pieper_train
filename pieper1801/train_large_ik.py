...
sys.path.insert(0, '/home/bonuli/Pieper/pieper1101')  # gpu_fk_wrapper
sys.path.insert(1, '/home/bonuli/Pieper/pieper1801')
...
logging.basicConfig(
    level=logging.INFO,
    format="%(message)s",
    handlers=[logging.StreamHandler(), logging.FileHandler("train_large_ik.log")]
)
...
class LargeConfig:
    ...
    # 保存路径
    checkpoint_path = "/home/bonuli/Pieper/pieper1801/large_improved_ik_best.pth"
...
def train():
    ...
    logging.info("=" * 70)
    logging.info("训练大容量改进IK模型")
    logging.info("=" * 70)
    logging.info(f"  架构: hidden_dim=512, heads=8, layers=5")
