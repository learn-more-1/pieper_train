...
def train():
    ...
    logging.info("=" * 70)
    logging.info("训练基于隐式神经场的IK模型（无历史帧版本）")
    logging.info("=" * 70)
    logging.info("核心特性:")
    ...
    # 断点路径
    checkpoint_path = f"/home/bonuli/Pieper/1901/{model_name}_2001.pth"
    ...
    for epoch in range(start_epoch, config.epochs):
        ...
        for batch_X, batch_y, batch_last_angle in train_loader:
            ...
            # 计算损失
            # 1. IK损失：预测角度 vs 目标角度
            ik_loss = mse_criterion(pred_joint_angles_denorm, target_angles)
