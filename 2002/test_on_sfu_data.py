"""
测试 implicit_ik_2002.pth 在 GRAB 数据集上的效果

测试2002优化版本：更大模型容量、更高FK权重、启用条件输入
"""
...
def test_on_grab_data():
    ...
    # print("=" * 70)
    # print("测试 implicit_ik_2002.pth (2002优化版本)")
    # print("=" * 70)

    # 加载模型
    checkpoint = torch.load("/home/bonuli/Pieper/2002/implicit_ik_2002_with_con.pth", weights_only=False)
    ...
    # 保存结果
    with open('/home/bonuli/Pieper/2002/grab_test_results_with_con.txt', 'w') as f:
        f.write("=" * 70 + "\n")
        f.write("GRAB数据集测试结果 (2002优化版本)\n")
        f.write("=" * 70 + "\n\n")
    ...
    print(f"\n✓ 结果已保存: /home/bonuli/Pieper/2002/grab_test_results_with_con.txt")
