...
import torch
import numpy as np
from pieper_direct import PieperCausalIKDirect as PieperCausalIK
...
def test_on_grab_data():
    ...
    checkpoint = torch.load("/home/bonuli/Pieper/pieper1003/pieper_direct_v2.pth")
    ...
    # 保存结果
    with open('/home/bonuli/Pieper/grab_test_results.txt', 'w') as f:
        f.write("=" * 70 + "\n")
        f.write("GRAB数据集测试结果\n")
        f.write("=" * 70 + "\n\n")
