...
## 2. pieper0902 模型 (PieperCausalIK) 0.3cm
...
## 3. pieper1002 模型 (PieperCausalIK 修正版) 3.611cm
...
## 4. pieper1003/pieper_direct.py (直接相乘版) 28.261cm
...
## 5. pieper1003/pieper_sefw.py (注意力+FiLM两阶段，无GNN) 25.243cm
